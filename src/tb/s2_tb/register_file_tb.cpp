...
verilator --trace --x-assign unique --x-initial unique -cc -I../../rtl/lib/ -I../../rtl/s1_fetch/ -I../../rtl/s2_decode/ -I../../rtl/s3_execute/ -I../../rtl/s4_writeback register_file.sv --exe register_file_tb.cpp

make -C obj_dir -f Vregister_file.mk Vregister_file

./obj_dir/Vregister_file +verilator+rand+reset+2
